...
namespace TransportCRM.Controllers
{
    ...
    public class TrucksController : Controller
    {
        ...
        public TrucksController(TransportCRMContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("TruckId,Name,MaxPayload")] Truck truck)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TruckId,Name,MaxPayload")] Truck truck)
        {
            if (id != truck.TruckId)
            {
                return NotFound();
